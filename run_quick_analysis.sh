...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --help)
            cat << 'HELP'
Quick phylogenetic analysis workflow for NXTTHRAX

Usage:
    bash run_quick_analysis.sh [OPTIONS]
...
Examples:
    # Standard run (no QC, faster)
    bash run_quick_analysis.sh

    # With both CheckM and BUSCO (recommended for publication)
    bash run_quick_analysis.sh --with-qc

    # CheckM only (skip BUSCO)
    bash run_quick_analysis.sh --with-qc --skip-busco

    # BUSCO only (skip CheckM)
    bash run_quick_analysis.sh --with-qc --skip-checkm
    ...
    bash run_quick_analysis.sh --with-qc --checkm-threads 16 --busco-threads 16
HELP
            exit 0
            ;;
        *)
...
# ---------------------------------------------------------------------------
log "=========================================================="
log "STEP 4: VCF Quality Filtering"
log "=========================================================="
...
# ---------------------------------------------------------------------------
log "=========================================================="
log "STEP 5: Unique SNP Filtering"
log "=========================================================="
...
# ---------------------------------------------------------------------------
log "=========================================================="
log "STEP 6: Clade SNP Validation"
log "=========================================================="
...
# ---------------------------------------------------------------------------
log "=========================================================="
log "STEP 7: Phylogenetic Analysis (Snakemake/Augur)"
log "=========================================================="
